...
global CCN;
addpath(genpath('/dors/booth/JBooth-Lab/BDL/LabCode/typical_data_analysis/2preprocessing')); %This is the code path
spm_path='/dors/booth/JBooth-Lab/BDL/LabCode/typical_data_analysis/spm12_elp'; %This is your spm path
tpm='/dors/booth/JBooth-Lab/BDL/LabCode/typical_data_analysis/templates_cerebroMatic/ELP_ses-7/mw_com_prior_Age_0096.nii'; %This is your template path
...
data_info='/dors/booth/JamesBooth/JBooth-Lab/BDL/jinwang/SemPhon_7_8/SemPhon_7_8.xlsx'; %final_sample sheet, the subject column should have sub plus subject number.(e.g. sub-5003)
if isempty(subjects)
