...
data=struct();
root='/dors/booth/JBooth-Lab/BDL/jinwang/SemPhon_7_8/preprocessed';  %your project path
subjects={}; % your subjects, if this is empty, then it will read in your data_info file
out_dir = '/dors/booth/JBooth-Lab/BDL/jinwang/SemPhon_7_8/secondlevel4/regression'; % your output folder of secondlevel analysis results
data_info='/dors/booth/JBooth-Lab/BDL/jinwang/SemPhon_7_8/data_info.xlsx';
...
name{1}='CTOPP_phoneme_isolation_Raw'; %make sure the name is the same as the header in your data_info.xls if you want to use data_info to read in data
